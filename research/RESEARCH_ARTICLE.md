...
- **ROI Efficiency:** "Extended Light" offered the best cost-to-biomass ratio, as CO2 injection costs ($40/burst) exhibit diminishing returns if not balanced with light intensity.
...
![30-Day Runway](../plots/11_capital_sweep_30day.png)
...
3. **Hardware Pilot:** Deploying the v1 Firmware to the RPi 5/Uno R4 WiFi stack based on these optimized 40K parameters.
